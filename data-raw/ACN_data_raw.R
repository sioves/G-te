...
bilpow_b1_acn <- data.frame(
  ...
  Time = c(
    rep("0", 3),  # RT 0
    rep("0", 3),  # 8C 0
    rep(c("24W","51W"), each = 3), # RT
    rep(c("24W","51"), each = 3)  # 8C
  ),
...
bil_b1_acn <- data.frame(
  ...
  Time = c(
    rep("0", 3),  # RT 0
    rep("0", 3),  # 8C 0
    rep(c("4W","12W","24W","36W","48W"), each = 3), # RT
    rep(c("4W","12W","24W","36W","48W"), each = 3)  # 8C
  ),
...
bil_b2_acn <- data.frame(
  ...
  Time = c(
    rep("0", 3),  # RT 0
    rep("0", 3),  # 8C 0
    rep(c("36W","51W"), each = 3), # RT
    rep(c("36W","51W"), each = 3)  # 8C
  ),
  Replicate = rep(1:3, times = 2 + 2*2),  # 3 replicates for each
  Value = c(
    # RT 0
